 ...
 */
MultiStatus.prototype.toXML = function (skipVals) {
  var D = 'DAV:';
  ...
  for (var i = 0; i < this.stats.length; ++i) {
    ...
    if (stat.props && stat.props.length > 0) {
      this._serializeProps(resEle, stat.props, skipVals)
    }
 ...
 */
MultiStatus.prototype._serializeProps = function (parent, props, skipVals) {
