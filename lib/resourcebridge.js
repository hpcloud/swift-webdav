 ...
 *
 * This is responsbile ONLY for DEAD properties. Live properties require
 * loading the resource itself, and thus should be handled by the load()
 * function.
 *
 * For the most part, this is considered an internal function, though
 * there is no reason it cannot be called externally.
 */
ResourceBridge.prototype.loadProperties = function (resource, fn) {
}
